...
from gym_pybullet_drones.examples.b1_wrapper import B1Wrapper
from gym_pybullet_drones.examples.b1_wrapper.b1_trot import trot
from gym_pybullet_drones.utils.utils import nnlsRPM

class DogDroneControl(BaseControl):
    ...
    def computeControl(self,
        ...
        cur_pos : ndarray
            (3+num_drones*3,1)-shaped array of floats containing the current position of the swarm.
        cur_quat : ndarray
            (4+4*num_drones,1)-shaped array of floats containing the current orientation of the swarm as a quaternion.
        cur_vel : ndarray
            (3+3*num_drones,1)-shaped array of floats containing the current velocity as a quaternion.
        cur_ang_vel : ndarray
            (3+3*num_drones,1)-shaped array of floats containing the current angular velocity.
        target_pos : ndarray
            (3+3*num_drones,1)-shaped array of floats containing the desired position.
        target_rpy : ndarray, optional
            (3+3*num_drones,1)-shaped array of floats containing the desired orientation as roll, pitch, yaw.
        target_vel : ndarray, optional
            (3+3*num_drones,1)-shaped array of floats containing the desired velocity.
        target_rpy_rates : ndarray, optional
            (3+3*num_drones,1)-shaped array of floats containing the the desired roll, pitch, and yaw rates.
